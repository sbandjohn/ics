...
Program Header:
  ...
  INTERP off    0x0000000000000238 vaddr 0x0000000000400238 paddr 0x0000000000400238 align 2**0
    ...
    LOAD off    0x0000000000000e10 vaddr 0x0000000000600e10 paddr 0x0000000000600e10 align 2**21
         filesz 0x0000000000000234 memsz 0x0000000000000248 flags rw-
...
Idx Name          Size      VMA               LMA               File off  Algn
 ...
 12 .plt.got      00000008  00000000004003d0  00000000004003d0  000003d0  2**3
                  CONTENTS, ALLOC, LOAD, READONLY, CODE
 13 .text         00000202  00000000004003e0  00000000004003e0  000003e0  2**4
                  CONTENTS, ALLOC, LOAD, READONLY, CODE
 14 .fini         00000009  00000000004005e4  00000000004005e4  000005e4  2**2
                  CONTENTS, ALLOC, LOAD, READONLY, CODE
 15 .rodata       00000004  00000000004005f0  00000000004005f0  000005f0  2**2
                  CONTENTS, ALLOC, LOAD, READONLY, DATA
 16 .eh_frame_hdr 0000004c  00000000004005f4  00000000004005f4  000005f4  2**2
                  CONTENTS, ALLOC, LOAD, READONLY, DATA
 17 .eh_frame     0000015c  0000000000400640  0000000000400640  00000640  2**3
                  CONTENTS, ALLOC, LOAD, READONLY, DATA
 ...
 23 .got.plt      00000020  0000000000601000  0000000000601000  00001000  2**3
                  CONTENTS, ALLOC, LOAD, DATA
 24 .data         00000024  0000000000601020  0000000000601020  00001020  2**3
                  CONTENTS, ALLOC, LOAD, DATA
 25 .bss          00000014  0000000000601044  0000000000601044  00001044  2**2
                  ALLOC
 26 .comment      00000034  0000000000000000  0000000000000000  00001044  2**0
                  CONTENTS, READONLY
SYMBOL TABLE:
...
0000000000400640 l    d  .eh_frame	0000000000000000              .eh_frame
...
0000000000601044 l     O .bss	0000000000000001              completed.7585
0000000000600e18 l     O .fini_array	0000000000000000              __do_global_dtors_aux_fini_array_entry
00000000004004b0 l     F .text	0000000000000000              frame_dummy
0000000000600e10 l     O .init_array	0000000000000000              __frame_dummy_init_array_entry
0000000000000000 l    df *ABS*	0000000000000000              main.c
0000000000601034 l     O .data	0000000000000004              globalA
0000000000601038 l     O .data	0000000000000004              x.1839
0000000000601048 l     O .bss	0000000000000004              x.1842
000000000060103c l     O .data	0000000000000004              staticMainB.1845
0000000000000000 l    df *ABS*	0000000000000000              add.c
0000000000601040 l     O .data	0000000000000004              globalA
0000000000000000 l    df *ABS*	0000000000000000              crtstuff.c
...
00000000004005f4 l       .eh_frame_hdr	0000000000000000              __GNU_EH_FRAME_HDR
0000000000601000 l     O .got.plt	0000000000000000              _GLOBAL_OFFSET_TABLE_
00000000004005e0 g     F .text	0000000000000002              __libc_csu_fini
00000000004004e2 g     F .text	000000000000000c              f2
0000000000000000  w      *UND*	0000000000000000              _ITM_deregisterTMCloneTable
0000000000601020  w      .data	0000000000000000              data_start
0000000000400551 g     F .text	000000000000001c              add
000000000060104c g     O .bss	0000000000000004              globalUnInit
...
00000000004004d6 g     F .text	000000000000000c              f1
0000000000400570 g     F .text	0000000000000065              __libc_csu_init
0000000000601058 g       .bss	0000000000000000              _end
00000000004003e0 g     F .text	000000000000002a              _start
0000000000601030 g     O .data	0000000000000004              str
0000000000601044 g       .bss	0000000000000000              __bss_start
00000000004004ee g     F .text	0000000000000063              main
...
0000000000601050 g     O .bss	0000000000000004              addX
...
00000000004003e0 <_start>:
  ...
  4003ed:	50                   	push   %rax
  4003ee:	54                   	push   %rsp
  4003ef:	49 c7 c0 e0 05 40 00 	mov    $0x4005e0,%r8
  4003f6:	48 c7 c1 70 05 40 00 	mov    $0x400570,%rcx
  4003fd:	48 c7 c7 ee 04 40 00 	mov    $0x4004ee,%rdi
  400404:	e8 b7 ff ff ff       	callq  4003c0 <__libc_start_main@plt>
  400409:	f4                   	hlt    
  40040a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)

0000000000400410 <deregister_tm_clones>:
  400410:	b8 4f 10 60 00       	mov    $0x60104f,%eax
  400415:	55                   	push   %rbp
  400416:	48 2d 48 10 60 00    	sub    $0x601048,%rax
  ...
  40042f:	5d                   	pop    %rbp
  400430:	bf 48 10 60 00       	mov    $0x601048,%edi
...
0000000000400450 <register_tm_clones>:
  400450:	be 48 10 60 00       	mov    $0x601048,%esi
  400455:	55                   	push   %rbp
  400456:	48 81 ee 48 10 60 00 	sub    $0x601048,%rsi
  ...
  40047d:	5d                   	pop    %rbp
  40047e:	bf 48 10 60 00       	mov    $0x601048,%edi
...
0000000000400490 <__do_global_dtors_aux>:
  400490:	80 3d ad 0b 20 00 00 	cmpb   $0x0,0x200bad(%rip)        # 601044 <_edata>
  ...
  4004a2:	5d                   	pop    %rbp
  4004a3:	c6 05 9a 0b 20 00 01 	movb   $0x1,0x200b9a(%rip)        # 601044 <_edata>
...
00000000004004d6 <f1>:
  ...
  4004da:	8b 05 58 0b 20 00    	mov    0x200b58(%rip),%eax        # 601038 <x.1839>
  4004e0:	5d                   	pop    %rbp
  4004e1:	c3                   	retq   
...
00000000004004e2 <f2>:
  ...
  4004e6:	8b 05 5c 0b 20 00    	mov    0x200b5c(%rip),%eax        # 601048 <__TMC_END__>
  4004ec:	5d                   	pop    %rbp
  4004ed:	c3                   	retq   

00000000004004ee <main>:
  4004ee:	55                   	push   %rbp
  4004ef:	48 89 e5             	mov    %rsp,%rbp
  4004f2:	53                   	push   %rbx
  4004f3:	48 83 ec 18          	sub    $0x18,%rsp
  4004f7:	8b 55 e4             	mov    -0x1c(%rbp),%edx
  4004fa:	8b 45 e0             	mov    -0x20(%rbp),%eax
  4004fd:	89 d6                	mov    %edx,%esi
  4004ff:	89 c7                	mov    %eax,%edi
  400501:	e8 4b 00 00 00       	callq  400551 <add>
  400506:	89 c2                	mov    %eax,%edx
  400508:	8b 05 26 0b 20 00    	mov    0x200b26(%rip),%eax        # 601034 <globalA>
  40050e:	01 d0                	add    %edx,%eax
  400510:	89 45 e8             	mov    %eax,-0x18(%rbp)
  400513:	b8 00 00 00 00       	mov    $0x0,%eax
  400518:	e8 b9 ff ff ff       	callq  4004d6 <f1>
  40051d:	89 c2                	mov    %eax,%edx
  40051f:	8b 45 e8             	mov    -0x18(%rbp),%eax
  400522:	8d 1c 02             	lea    (%rdx,%rax,1),%ebx
  400525:	b8 00 00 00 00       	mov    $0x0,%eax
  40052a:	e8 b3 ff ff ff       	callq  4004e2 <f2>
  40052f:	8d 14 03             	lea    (%rbx,%rax,1),%edx
  400532:	8b 05 04 0b 20 00    	mov    0x200b04(%rip),%eax        # 60103c <staticMainB.1845>
  400538:	01 c2                	add    %eax,%edx
  40053a:	8b 05 10 0b 20 00    	mov    0x200b10(%rip),%eax        # 601050 <addX>
  400540:	01 d0                	add    %edx,%eax
  400542:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400545:	b8 00 00 00 00       	mov    $0x0,%eax
  40054a:	48 83 c4 18          	add    $0x18,%rsp
  40054e:	5b                   	pop    %rbx
  40054f:	5d                   	pop    %rbp
  400550:	c3                   	retq   
...
0000000000400551 <add>:
  ...
  400561:	01 c2                	add    %eax,%edx
  400563:	8b 05 d7 0a 20 00    	mov    0x200ad7(%rip),%eax        # 601040 <globalA>
  400569:	01 d0                	add    %edx,%eax
  40056b:	5d                   	pop    %rbp
  40056c:	c3                   	retq   
